...
if (!function_exists('dump')) {
    ...
    function dump(...$data)
    {
        if (php_sapi_name() === 'cli' || (function_exists('xdebug_is_enabled') && xdebug_is_enabled())) {
            var_dump($data);
            return;
        }
        echo '<pre style="font-size: 13px; font-family: Monaco, monospace; background-color: #f5f5f5; border: 1px solid #ccc; padding: 5px; margin: 10px; border-radius: 5px; box-shadow: 0 0 5px rgba(0, 0, 0, 0.2);">';
