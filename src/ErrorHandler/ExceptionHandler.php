...
namespace PhpDevCommunity\Michel\Core\ErrorHandler;
...
use PhpDevCommunity\Michel\Core\ErrorHandler\ErrorRenderer\JsonErrorRenderer;
use PhpDevCommunity\Michel\Core\Http\Exception\HttpException;
